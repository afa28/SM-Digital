...
<html class="no-js">
    ...
    <meta property="og:site_name" content="https://soemultidigital.id" />
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					...
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://soemultidigital.id/" target="_blank">M Fikri Setiadi</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
