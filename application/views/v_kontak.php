	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">SOE MULTI DIGITAL<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Jl. Poros Galesong Selatan, Kampung Parang, Kelurahan Bontoramba, Kecamatan Bontonompo Selatan, Kab. Gowa</li>
						<li><i class="icon-phone"></i>081341966002</li>
						<li><i class="icon-envelope"></i><a href="#">info@soemultidigital.id</a></li>
						<li><i class="icon-globe"></i><a href="#">www.soemultidigital.id</a></li>
					</ul>
				</div>
