...
<html class="no-js">
	...
	<title>Welcome To Soe Multi Digital</title>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Dapatkan Aplikasi SIAP BE untuk Desa Anda</h2>
	...
	<div class="fh5co-section-with-image">
		...
		<div class="fh5co-box animate-box">
			<h2>Penuh Inovasi</h2>
			<p>Kami selalu membangun aplikasi dengan menggunakan teknologi tepat guna.</p>
